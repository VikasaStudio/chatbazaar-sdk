...
export class InventoryService extends Service {
    ...
    getVariantsByGroupId(variantGroupId, options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            let response = yield this.fetchApi(`/product/${variantGroupId}`, null, Object.assign(Object.assign({}, options), { method: "GET" }));
            return response;
        });
    }
    findVariants(searchQuery, options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            let response = yield this.fetchApi(`/variant`, searchQuery, Object.assign(Object.assign({}, options), { method: "GET" }));
            return response;
        });
    }
