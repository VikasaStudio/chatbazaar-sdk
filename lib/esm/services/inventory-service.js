...
export class InventoryService extends Service {
    ...
    createBulkVariants(payload, options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            let response = yield this.fetchApi("/bulk-variants", { data: payload }, Object.assign(Object.assign({}, options), { method: "POST" }));
            return response;
        });
    }
    patchBulkVariantyQuantity(payload, options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            let response = yield this.fetchApi("/bulk-variants/quantity", { data: payload }, Object.assign(Object.assign({}, options), { method: "PATCH" }));
            return response;
        });
    }
