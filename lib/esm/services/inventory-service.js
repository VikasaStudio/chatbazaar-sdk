...
export class InventoryService extends Service {
    ...
    getVariantsByGroupId(vendorId, variantGroupId, options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            let response = yield this.fetchApi(`${vendorId}/product/${variantGroupId}`, null, Object.assign(Object.assign({}, options), { method: "GET" }));
            return response;
        });
    }
