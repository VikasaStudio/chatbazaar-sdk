...
export class OrderService extends Service {
    ...
    getActiveOrders(vendorId, queryParams, options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.fetchApi(`/${vendorId}/orders`, queryParams, Object.assign(Object.assign({}, options), { method: "GET" }));
            return response;
        });
    }
}
