...
var Service = (function () {
    function Service(serviceBaseUrl, serviceToken, loggerEnabled) {
        if (loggerEnabled === void 0) { loggerEnabled = false; }
        this.url = serviceBaseUrl;
        this.serviceToken = serviceToken;
        this.loggerEnabled = loggerEnabled;
    }
    Service.prototype.fetchApi = function (requestUrl, payload, method) {
        if (payload === void 0) { payload = null; }
        if (method === void 0) { method = "GET"; }
        return __awaiter(this, void 0, void 0, function () {
            var fetchOptions, url, qs, response, result, err_1;
                    ...
                    case 0:
                        ...
                        fetchOptions = {
                            ...
                            headers: {
                                ...
                                Authorization: "Basic ".concat(this.serviceToken),
                            },
                        };
                        ...
                        if (payload && Object.keys(payload).length > 0) {
                            if (method !== "GET")
                                ...
                                qs = querystring_1.default.stringify(payload || {});
